...
class Game(object):
    def __init__(self):
        ...
        self.enemies.add(Fatman(288,96,0,2))
        self.enemies.add(Fatman(288,320,0,-2))
        self.enemies.add(Fatman(544,128,0,2))
        self.enemies.add(Fatman(32,224,0,2))
        self.enemies.add(Fatman(160,64,2,0))
        self.enemies.add(Fatman(448,64,-2,0))
        self.enemies.add(Fatman(640,448,2,0))
        self.enemies.add(Fatman(448,320,2,0))
    ...
    def display_frame(self,screen):
        ...
        if self.game_over:
            if self.about:
                self.display_message(screen,"PIKK-MANN")
